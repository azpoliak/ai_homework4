...
class Classifier:
    ...
    def train(self, training_data):
        ...
        if self.classifier_type == 'neural_network':
            ...
            self.nn = Neural_Network("neural_network",weights = [], num_input=self.params['num_input'], num_hidden=1000, num_output=self.params['num_output'], alt_weight=self.params['one']=='1')
